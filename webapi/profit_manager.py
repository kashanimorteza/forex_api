#--------------------------------------------------------------------------------- location
# webapi/routes/profit_manager.py

#--------------------------------------------------------------------------------- Description
# This is route for profit_manager

#--------------------------------------------------------------------------------- Import
from logic.logic_util import model_output
from logic.logic_global import database_management
from fastapi import APIRouter, Request
from model.model_profit_manager import model_profit_manager_py as model_py
from model.model_profit_manager import model_profit_manager_db as model_db
